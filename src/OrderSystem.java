...
public class OrderSystem {
	...
	// this is just the sample data we use
	private void initializeData() {
		...
		// maps name of song to the member
	...
	// UI and functionality for ordering
	public void orderUI() {
		...
		System.out.println(
				"Finally, please enter a 16 digit number of the credit card you want to use for this purchase");
		long creditcard = 0;
	...
	// UI and functionality for member reporting song complete
	...
	// displays member status' and order status' for each member
		...
		for (int i = 1; i <= 7; i++) {
			...
			if (!orders.isEmpty()) {
				...
				for (int j = 0; j < orders.size(); j++) {
					...
					System.out.println("  " + (j + 1) + ". Sweetheart: " + o.getSweetheart() + ", Customer: "
							+ o.getEmail() + ", Card: " + o.getCard() + ", Completed: " + o.getCompleted());
				}
			}
			System.out.println();
		}
